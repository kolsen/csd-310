...
def display_report(rows):
    ...
    # Display Header
    print("Equipment ID | Equipment Assigned | Equipment Type | Customer | Customer Phone | Customer Email | Location")
    print("-" * 110)

    for row in rows:
        equipment_id, equipment_assigned, equipment_type, customer, customer_phone, customer_email, location = row
        print(f"{equipment_id:12} | {equipment_assigned:18} | {equipment_type:15} | {customer:15} | {customer_phone:14} | {customer_email:35} | {location}")
